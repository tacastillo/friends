            ...
            <div>
                ...
                <div className="caption-container text-block">
                    <div className="caption">
                        ...
                        <p>
                            Thank you for taking the time to look through these visualizations. If you would like to contact me, you can tweet me <a href="https://twitter.com/timangcas" target="_blank">@timangcas</a>. To find any of my other work, you can check my <a href="https://tacastillo.github.io/" target="_blank">website</a>. All code from this site, including the web scraper and Jupyter notebook, can be found on its <a href="https://github.com/tacastillo/friends" target="_blank">github repo</a> for further analysis. If you're curious on how any of this code works, please free to hit me up and shoot me a question. Data visualization is all about sharing information, and I believe that it doesn't end when you're finished reading a graph.
                        </p>
                        <p>
